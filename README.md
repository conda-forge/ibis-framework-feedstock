...
Once the `conda-forge` channel has been enabled, `ibis-framework, ibis-framework-core` can be installed with:

```
conda install ibis-framework ibis-framework-core
```
