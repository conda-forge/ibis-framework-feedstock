...
```
conda install ibis-bigquery ibis-clickhouse ibis-dask ibis-datafusion ibis-druid ibis-duckdb ibis-framework ibis-framework-core ibis-impala ibis-mssql ibis-mysql ibis-oracle ibis-pandas ibis-polars ibis-postgres ibis-pyspark ibis-snowflake ibis-sqlite ibis-trino
```

or with `mamba`:

```
mamba install ibis-bigquery ibis-clickhouse ibis-dask ibis-datafusion ibis-druid ibis-duckdb ibis-framework ibis-framework-core ibis-impala ibis-mssql ibis-mysql ibis-oracle ibis-pandas ibis-polars ibis-postgres ibis-pyspark ibis-snowflake ibis-sqlite ibis-trino
```
